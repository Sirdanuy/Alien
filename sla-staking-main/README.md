# Alienhood Staking UI 

This repository hosts the UI interface to the Alienhood  staking UI: https://staking.secretllamaagency.com/.

The implementation was forked from the Cardinal Staking UI and tweaked to meet the needs of SLA. 

The documentation below is from the original repository, and is still applicable. 
