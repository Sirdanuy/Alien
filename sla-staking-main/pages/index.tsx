...
function Home() {
  ...
  const [loadingRefreshYield, setLoadingRefreshYield] = useState(false)
  ...
  return (
    <div style={{ background: stakePoolMetadata?.colors?.primary }}>
      <Head>
        <title>Alienhood Staking</title>
        <meta name="description" content="Alienhood  Staking page" />
        ...
        {(maxStaked || rewardDistributorData) && !stakePoolMetadata?.notFound && (
          ...
          >
            ...
            {rewardDistributorData.data && rewardMintInfo.data ? (
              <>
                <div className="inline-block text-lg">
                  <span>Base Yield (per Agent)</span>:{' '}
                  <span>
                    {(
                      (Number(
                        getMintDecimalAmountFromNatural(
                          ...
                          >
                            ...
                            >
                              ...
                              <QuickActions
                                ...
                                setLoadingRefreshYield={setLoadingRefreshYield}
